    ...
    <div class="container-fluid page-body-wrapper full-page-wrapper auth-page">
      <div class="content-wrapper d-flex align-items-center auth register-bg-1 theme-one">
        <div class="row w-100">
            ...
            <h1 class="text-center mb-4">Profile Update Successful!</h1>
...
<span><% String FirstName = request.getParameter("FirstName");%></span><br>
		
<label>Lastname:</label>
<span><% String LastName = request.getParameter("LastName");%></span><br>
		
<label>Profession:</label>
<span><% String Profession = request.getParameter("Profession");%></span><br>
		
<label>Date Of Birth:</label>
<span><% String DateOfBirth = request.getParameter("DateOfBirth");%></span><br>
		
<label>Company name or Freelancer:</label>
<span><% String CompanyFreelancer = request.getParameter("CompanyFreelancer");%></span><br>
		
<label>City:</label>
<span><% String City = request.getParameter("City");%></span><br>
		
<label>Country:</label>
<span><% String Country = request.getParameter("Country");%></span><br>
		
<label>Email:</label>
<span><% String Email = request.getParameter("Email");%></span><br>
		
<label>Package Type:</label>
<span><% String Profile = request.getParameter("Profile");%></span><br>

<form action="" method="get">
<input type="submit" value="Continue" href="login.html" >
