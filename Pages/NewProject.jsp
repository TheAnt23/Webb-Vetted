...
<body>
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="#">
          <img src="../Support/images/W&Vlogo.png" id="Logo" alt="logo" />
        </a>
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center">
        <ul class="navbar-nav navbar-nav-left header-links d-none d-md-flex">
          <li class="nav-item active">
            <a href="NewProject.jsp" class="nav-link">New Project
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block">
            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              <span class="profile-text">Hello, Client !</span>
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              ...
              <a class="dropdown-item mt-2" href="UpdateProfileClient.jsp">
                Manage Account
              </a>
              <a class="dropdown-item">
                Change Password
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="ClientHome.jsp">
              <i class="menu-icon mdi mdi-television"></i>
              <span class="menu-title">Dashboard</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="DevelopersList.jsp">
              <i class="fa fa-address-book-o"></i>
              <span class="menu-title">Developers</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="ClientProjects.jsp">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="auto-form-wrapper">
              ...
              <form action="NewProjectServer" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="Eg:C123456" name="ProjectID" required>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="SmartKids Website" name="ProjectTitle" required>
                          </div>
                        </div>
                      </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="Eg: Botswana Accountancy College" name="Client" required>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="number" class="form-control" placeholder="Eg: 10 000" name="Budget" >
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="date" class="form-control" placeholder="Eg: YYYY-MM-DD" name="Deadline" >
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="date" class="form-control" placeholder="Eg: YYYY-MM-DD" name="StartDate" >
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <input type="submit" value="Register" id="submit" class="btn btn-primary submit-btn btn-block" >
                </div>               
              </form>
                </div>
              </div>
  ...
  <script src="../Support/js/vendor.bundle.addons.js"></script>
  <!-- endinject -->
  ...
  <script src="../Support/js/dashboard.js"></script>
