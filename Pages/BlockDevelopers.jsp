    ...
    <div class="container-fluid page-body-wrapper">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="BlockClient.jsp"> Clients </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="BlockDevelopers.jsp"> Developers </a>
                </li>
              </ul>
            </div>
          </li>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
				<form action="BlockUsersServer" method="post">
              ...
              <div class="card">
                     ...
                     Block User
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <textarea class="form-control" placeholder="Enter Your reason" name="Reason">
                ...
                <div class="form-group">
                  <input type="submit" value="Block" id="submit" class="btn btn-secondary submit-btn btn-block" >
                </div>
