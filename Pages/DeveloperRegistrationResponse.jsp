...
<span><% String Profession = request.getParameter("Profession");%><%=Profession.toString() %></span><br>
...
<span><% String CompanyFreelancer = request.getParameter("CompanyFreelancer");%><%=CompanyFreelancer.toString() %></span><br>
		
<label>City:</label>
<span><% String City = request.getParameter("City");%><%=City.toString() %></span><br>
		
<label>Country:</label>
<span><% String Country = request.getParameter("Country");%><%=Country.toString() %></span><br>
...
<span><% String Profile = request.getParameter("Profile");%><%=Profile.toString() %></span><br>

<p>To continue to Login, click "Login" or "Home" to go to home page</p>

<form action="RegisterDeveloperServer" method="get">
