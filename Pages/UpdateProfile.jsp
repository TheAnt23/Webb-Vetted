    ...
    <div class="container-fluid page-body-wrapper">
            ...
            <div class="nav-link">
              <div class="user-wrapper">
                ...
                <div class="text-wrapper">
                  ...
                  <div>
                    <small class="designation text-muted">Hillbrew Studios</small>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
               ...
               <form action="UpdateProfileServer" method="post">
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="date" class="form-control" placeholder="Eg: 07-JUL-2019" name="DateOfBirth" required>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Company name Or Freelancer</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="Company/Freelancer" name="CompanyFreelancer" required>
                          </div>
                        </div>
                      </div>
                    </div>
